...
public class JTEuropeErrorHandler {

    private Stage ui;

    public JTEuropeErrorHandler(Stage initUI) {
        ui = initUI;
    }
     ...
     */
    public void processError(JTEuropePropertyType errorType) {
        ...
        String errorTitle = props.getProperty(JTEuropePropertyType.ERROR_DIALOG_TITLE_TEXT);
